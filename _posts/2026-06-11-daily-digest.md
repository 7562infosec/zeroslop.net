---
layout: post
title: "ZeroSlop — June 11, 2026"
date: 2026-06-11
slug: "daily-digest-2026-06-11"
description: "Today: HERO: Hindsight-Enhanced Reflection from Environment…; Google DeepMind is worried about what happens when…; “Giant superatoms” could finally solve quantum…"
...
### 1. [HERO: Hindsight-Enhanced Reflection from Environment Observations for Agentic Self-Distillation](https://arxiv.org/abs/2606.11559)
*arXiv CS.AI*
...
### 2. [Google DeepMind is worried about what happens when millions of agents start to interact](https://www.technologyreview.com/2026/06/11/1138794/google-deepmind-is-worried-about-what-happens-when-millions-of-agents-start-to-interact/)
*MIT Tech Review*
...
### 3. [“Giant superatoms” could finally solve quantum computing’s biggest problem](https://www.sciencedaily.com/releases/2026/04/260413043155.htm)
*Science Daily AI*
...
### 5. [Running Python code in a sandbox with MicroPython and WASM](https://simonwillison.net/2026/Jun/6/micropython-in-a-sandbox/#atom-everything)
*Simon Willison*
...
### 6. [Jedify raises $24M to help companies arm AI agents with context on their business](https://techcrunch.com/2026/06/10/jedify-raises-24m-to-help-companies-arm-ai-agents-with-context-on-their-business/)
*TechCrunch AI*
...
### 7. [For Robotaxis, Safety Must Be Built In, Not Bolted On](https://blogs.nvidia.com/blog/halos-os-robotaxi-safety/)
*NVIDIA Blog*
...
### 8. [Architecture-Aware Reinforcement Learning Makes Sliding-Window Attention Competitive in Math Reasoning](https://arxiv.org/abs/2606.11634)
*arXiv CS.AI*
...
### 9. [ChatGPT as a therapist? New study reveals serious ethical risks](https://www.sciencedaily.com/releases/2026/03/260302030642.htm)
*Science Daily AI*
...
### 10. [DiffusionGemma](https://simonwillison.net/2026/Jun/10/diffusiongemma/#atom-everything)
*Simon Willison*
...
### 11. [RVPO: Risk-Sensitive Alignment via Variance Regularization](https://machinelearning.apple.com/research/rvpo-risk-sensitive-alignment)
*Apple ML Journal*
...
### 12. [Claude Fable won’t answer basic biology questions](https://www.theverge.com/ai-artificial-intelligence/947973/fable-wont-answer-basic-biology-questions)
*The Verge AI*
