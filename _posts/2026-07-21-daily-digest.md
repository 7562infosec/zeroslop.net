---
layout: post
title: "ZeroSlop — July 21, 2026"
date: 2026-07-21
slug: "daily-digest-2026-07-21"
description: "Today: LVSum: A Benchmark for Timestamp-Aware Long Video…; At SIGGRAPH, NVIDIA Advances Graphics and Simulation…; Safety and alignment in an era of long-horizon models"
...
### 1. [LVSum: A Benchmark for Timestamp-Aware Long Video Summarization](https://machinelearning.apple.com/research/lvsum-video-summarization)
*Apple ML Journal*
...
### 2. [At SIGGRAPH, NVIDIA Advances Graphics and Simulation With Agentic and Physical AI](https://blogs.nvidia.com/blog/siggraph-news-2026/)
*NVIDIA Blog*
...
### 4. [“Stealth Crawlers” Are Not a Threat to the Open Web. Bills Targeting Them Would Be.](https://www.eff.org/deeplinks/2026/07/stealth-crawlers-are-not-threat-open-web-bills-targeting-them-would-be)
*EFF Updates*
...
### 5. [Head of US Safety Agency Resigns](https://news.slashdot.org/story/26/07/20/1948206/head-of-us-safety-agency-resigns?utm_source=rss1.0mainlinkanon&utm_medium=feed)
*Slashdot*
...
### 7. [From Modalities to Propositions: A Language-Centric Framework for Multimodal Intelligence](https://arxiv.org/abs/2607.16560)
*arXiv CS.AI*
...
### 8. [Adobe’s ‘natural look’ camera app embraces generative AI](https://www.theverge.com/tech/967791/adobe-indigo-camera-app-ai-playground-update)
*The Verge AI*
...
### 9. [RAIL Guard: Closing the Evaluation-to-Remediation Gap in Responsible AI for LLM Agents](https://arxiv.org/abs/2607.16215)
*arXiv CS.AI*
...
### 10. [Quoting Sam Altman](https://simonwillison.net/2026/Jul/20/sam-altman/#atom-everything)
*Simon Willison*
...
### 11. [Man of his word: Pope Leo speeches declared human-authored by Australian AI detection tool](https://www.theguardian.com/world/2026/jul/21/pope-leo-speech-human-not-ai-artificial-intelligence)
*The Guardian Tech*
...
### 12. [NVIDIA Releases Cosmos 3 Edge: A 4B-Parameter Open World Model That Reasons and Generates Robot Actions On-Device](https://www.marktechpost.com/2026/07/21/nvidia-releases-cosmos-3-edge-a-4b-parameter-open-world-model-that-reasons-and-generates-robot-actions-on-device/)
*MarkTechPost*
